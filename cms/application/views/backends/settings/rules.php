<div class="container-fluid wrapper">
	...
	<form class="form-horizontal" id="form" method="post" action="" enctype="multipart/form-data">
		<fieldset>
			<legend>
				<?php echo lang('msg_settings');?>&nbsp;-&nbsp;<?php echo lang('msg_rules');?>
			</legend>

			<div class="form-group">
				<label class="control-label col-xs-2" for="txtName"><?php echo lang('msg_content');?></label>
				<div class="controls col-xs-10">
					<textarea rows="10" id="content" name="content" class="form-control"><?php echo $obj['rules'];
						?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-xs-10 col-xs-offset-2">
						...
						<a href="<?php echo base_url();?>admin/settings/reset_rules_settings" class="btn btn-default">
